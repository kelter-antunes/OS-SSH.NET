...
namespace Renci.OS.SshNet.Benchmarks.Common
{
    [MemoryDiagnoser]
    [ShortRunJob]
    public class HostKeyEventArgsBenchmarks
    {
        ...
        {
            using (var s = typeof(HostKeyEventArgsBenchmarks).Assembly.GetManifestResourceStream("Renci.OS.SshNet.Benchmarks.Data.Key.RSA.txt"))
            {
