...
using Renci.OS.SshNet.Security;
using Renci.OS.SshNet.Security.Cryptography;

namespace Renci.OS.SshNet.Benchmarks.Security.Cryptography
{
    [MemoryDiagnoser]
    public class ED25519DigitalSignatureBenchmarks
    {
        ...
        public ED25519DigitalSignatureBenchmarks()
        {
            ...
            using (var s = typeof(ED25519DigitalSignatureBenchmarks).Assembly.GetManifestResourceStream("Renci.OS.SshNet.Benchmarks.Data.Key.OPENSSH.ED25519.txt"))
            {
