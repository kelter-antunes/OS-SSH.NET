...
using Renci.OS.SshNet.Compression;
using Renci.OS.SshNet.Connection;
using Renci.OS.SshNet.Messages;
using Renci.OS.SshNet.Messages.Authentication;
using Renci.OS.SshNet.Messages.Connection;
...
namespace Renci.OS.SshNet
{
    ...
    public class Session : ISession
    {
        ...
        internal Session(ConnectionInfo connectionInfo, IServiceFactory serviceFactory, ISocketFactory socketFactory)
        {
            ...
            ClientVersion = "SSH-2.0-Renci.OS.SshNet.SshClient.0.0.1";
